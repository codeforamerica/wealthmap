...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('wealthmap', '0004_auto_20160207_0402'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='opportunity',
            name='agency',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='wealthmap.Agency', verbose_name='agency'),
        ),
        migrations.AlterField(
            model_name='opportunity',
        ...
        migrations.AlterField(
            model_name='opportunity',
            name='requirement',
            field=models.ManyToManyField(through='wealthmap.RequirementRelationship', to='wealthmap.Requirement', verbose_name='requirement'),
        ),
        migrations.AlterField(
            model_name='opportunity',
            name='title',
        ...
        migrations.AlterField(
            model_name='requirementrelationship',
            name='opportunity',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='wealthmap.Opportunity', verbose_name='opportunity'),
        ),
        migrations.AlterField(
            model_name='requirementrelationship',
            name='requirement',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='wealthmap.Requirement', verbose_name='requirement'),
        ),
        migrations.AlterField(
            model_name='requirementrelationship',
            name='updated_at',
